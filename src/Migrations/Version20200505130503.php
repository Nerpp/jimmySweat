 ...
 */
final class Version20200505130503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E1D902C17ED56D5 ON tricks');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E1D902C17ED56D5 ON tricks (fk_tricks_group_id)');
